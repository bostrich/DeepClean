...
Java_com_syezon_clean_FFmpegNativeBridge_innerRunCommand(JNIEnv *env, jclass type,
...
Java_com_syezon_clean_FFmpegNativeBridge_setDebug(JNIEnv *env, jclass type, jboolean debug) {
